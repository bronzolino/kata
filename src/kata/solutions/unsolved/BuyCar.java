 ...
 * the new one decrease of 1.5 percent per month. Furthermore the percent of
 * loss increases by a fixed 0.5 percent at the end of every two months.
 * 
 * Example of percents lost per month:
 * 
 * If, for example, at the end of first month the percent of loss is 1, end of
 * second month percent of loss is 1.5, end of third month still 1.5, end of
 * 4th month 2 and so on ...
 * 
 ...
 * Calculations are processed at the end of each considered month but if, by
 * chance from the start, the value of the old car is bigger than the value of
 * the new one or equal there is no saving to be made, no need to wait so he can
